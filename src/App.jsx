    ...
    <header className="hero">
      <div>
        ...
        <p className="subtitle">
          Инструмент: <strong>Figma</strong> (файл проекта подготовлен для согласования).
          Ниже — каркас ключевых экранов с подписями и плейсхолдерами.
        </p>
      </div>
    </header>
      ...
      <div className="dashboard-grid">
        ...
        <div className="card">
          ...
          <div className="chart-placeholder">
            ...
            <div className="chart-body">Основной график (линейный/area)</div>
          </div>
        </div>
    ...
    <section className="section" aria-label="Positions wireframe">
      ...
      <div className="positions-grid">
        <div className="card">
          ...
          <div className="table-footer">Плейсхолдер: пагинация · поиск · фильтры</div>
        </div>
        ...
        <div className="card">
          ...
          <div className="detail-grid">
            ...
            <div className="detail-block">
              ...
              <div className="summary-placeholder">Timeline / logs placeholder</div>
            </div>
          </div>
        </div>
      </div>
